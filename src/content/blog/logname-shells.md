...
description: "Debugging a cryptic build failure caused by the LOGNAME environment variable not being set in containerized non-login shells."
date: 2016-09-12
tags: ["docker", "containers", "bash", "linux"]
---
...
you get a non-interactive non-login shell, _BUT_ SSH sets some additional environment variables of
...
container runs the `slave.jar` in a non-interactive, non-login shell that is _not_ spawned by SSH,
