...
description: "A practical guide to getting started with Mozilla's TaskCluster, based on my experience migrating Spidermonkey builds."
date: 2015-07-20
tags:
  [
    "internship",
...
&nbsp;</p>
<ul>
<li>Figure out the different possible combinations of variables (platform, type, etc.) that spidermonkey builds can take. See this comment(Add these to <a href="https://hg.mozilla.org/try">Try</a>/<a href="https://treeherder.mozilla.org">Treeherder</a> by</li><br />
</ul></p>
<ol>
<li>Adding job flags <a href="https://dxr.mozilla.org/mozilla-central/source/testing/taskcluster/tasks/job_flags.yml">here</a></li>
<li>Also adding them in a slightly different format <a href="https://dxr.mozilla.org/mozilla-central/source/testing/taskcluster/tasks/branches/try/job_flags.yml">here</a></li>
<li>Finally create job configurations under <a href="https://dxr.mozilla.org/mozilla-central/source/testing/taskcluster/tasks/builds">here</a></li>
